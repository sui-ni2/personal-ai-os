...
- Iteration 5: completed a static accessibility pass. More, Conversation History, Model Selector, and Save to Memory now lock background scroll where appropriate, move focus into the modal, trap Tab/Shift+Tab, support Escape, and restore focus to their triggers. Primary mobile controls found below 44 px were raised to 44 px or more. Automated checks pass; keyboard and touch behavior remain browser-unverified because implementation capture/control is unavailable.
